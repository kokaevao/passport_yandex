...
class Logger():
    file_name = f"C:\\Users\\akokaev\\Desktop\\Learn_Python\\passport_yandex\\logs\\log_" + str(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")) + ".log"
